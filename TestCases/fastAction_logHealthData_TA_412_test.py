...
def test_user_enter_health_logs_from_fast_action(setup_appium_driver):
    print("Test Case Started - TA-412 - User Should Be Able To Enter Their Health Logs From Fast Action")
    ...
    fast_action.click_logHealthData()
