...
def test_user_add_sleep_details(setup_appium_driver):
    print("Test Case Started - TA-417 - User Should Be Able To Add Sleep Details")
    ...
    sleep_details.click_sleep_btn()
    sleep_details.drop_down()
    sleep_details.select_duration()
    sleep_details.click_save()
